        ...
        <Container>
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="order-1 lg:order-2 relative">
              ...
              <img src="https://images.unsplash.com/photo-1551522435-a13afa10f103?auto=format&fit=crop&q=80" alt="Leadership Team" className="relative z-10 rounded-2xl shadow-medium aspect-[4/3] object-cover" />
            </motion.div>
          </div>
        </Container>
      </Section>
